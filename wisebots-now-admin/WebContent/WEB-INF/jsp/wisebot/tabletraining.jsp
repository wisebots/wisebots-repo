...
<h2>Training Table Statistics</h2><br/>
<table cellpadding="4" cellspacing="0" style="border-collapse: collapse;">
<tr>
<td width="80" align="center">EPOCHS</td><td width="80" align="center">STATES</td><td width="120" align="center">TIME</td><td width="80" align="center">QUALITY</td><td width="80" align="center">VICTORY</td><td width="80" align="center">DRAW</td>
</tr>
		<c:forEach items="${botHistoryList}" var="botHistory">
		<tr>
		<td width="80" align="center" style="border:1px solid;">${botHistory.epochs}</td><td width="80" align="center" style="border:1px solid;">${botHistory.nustates}</td><td width="120" align="center" style="border:1px solid;">${botHistory.time} secs</td><td width="80" align="center" style="border:1px solid;">${botHistory.quality} %</td><td width="80" align="center" style="border:1px solid;">${botHistory.victory} %</td><td width="80" align="center" style="border:1px solid;">${botHistory.draw} %</td>   
		</tr>
		</c:forEach>
</table>
